...
if (!isset($_GET['bdtaskcrm_quotation_view_nonce']) || !wp_verify_nonce($_GET['bdtaskcrm_quotation_view_nonce'], 'bdtaskcrm_action_view')) {
	                    ...
	                    <div class="panel-body">
	                    	<div class="row">
	                            ...
	                            <div class="col-sm-2 text-left" style="display: inline-block;margin-left: 5px;float: right;">
	                            	...
	                            	<?php echo esc_html('Invoice','bdtaskcrm');?></div>
	                        ...
	                        <div class="row">
	                            ...
	                            <div class="col-sm-2 text-left" style="display: inline-block;margin-left: 5px;float: right;">
                                    ...
                                    <address style="margin-top:10px">
                                        <strong><?php echo esc_html($update_qutation[0]->first_name.'  '.$update_qutation[0]->last_name);?></strong><br>
                                        <abbr><?php echo esc_html('Address:','bdtaskcrm');?></abbr>
                                        <c style="width: 10px;margin: 0px;padding: 0px;"><?php echo esc_html($update_qutation[0]->address);?>
                                        </c>
                                        <br>
                                        <abbr><?php echo esc_html('Mobile:','bdtaskcrm');?></abbr>
                                        <?php echo esc_html($update_qutation[0]->phone);?> 
                                        </br>
                                        <abbr><?php echo esc_html('Email:','bdtaskcrm');?></abbr><?php echo esc_html($update_qutation[0]->email);?>
                                    </address>
	                            ...
	                            <table class="table table-striped">
	                                <thead>
	                                    <tr>
	                                        ...
	                                        <th><?php echo esc_html('Qty','bdtaskcrm');?></th>
									...
									?>
										<tr>
	                                        ...
	                                        <td style="width:20%;">$<?php echo esc_html($al_dis);?>
	                                         (<?php echo esc_html($value->product_discount) ;?>%)</td>
